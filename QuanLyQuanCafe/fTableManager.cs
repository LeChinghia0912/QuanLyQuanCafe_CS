...
namespace QuanLyQuanCafe
{
    public partial class fTableManager : Form
    {
        ...
        void LoadTable()
        {
            ...
            //Gọi phương thức LoadTableList từ TableDAP.Intance để lấy danh sách bàn
        ...
        private void btnAddFood_Click(object sender, EventArgs e)
        {
            ...
            if (table == null)
            {
                MessageBox.Show("Vui lòng chọn bàn để thực hiện thêm món!");
                return;
            }
        ...
        private void btnCheckOut_Click(object sender, EventArgs e)
        {
            ...
            if(table == null)
            {
                MessageBox.Show("Vui lòng chọn bàn để thực hiện thanh toán!");
                return;
            }
        ...
        private void btnSwitchTable_Click(object sender, EventArgs e)
        {
            ...
            if (table == null)
            {
                MessageBox.Show("Vui lòng chọn bàn để thực hiện chuyển bàn!");
                return;
            }
            ...
            {
                TableDAO.Instance.SwtichTable(id1, id2);
